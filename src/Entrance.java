 ...
 * In the main() method,
 * it will create a restaurant.Menu instance and invoke load() and display() method.
 * <p>
 * load() method is to read today's meal list, drink list, ingredient list from files in recipe folder and
 * assign these contents to restaurant.Menu instance fields and Stock class fields.
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            while (orderingDrink) {
                ...
                if (drink == null) {
                    System.out.println("Sorry, we don't have this drink. Please check the menu.");
                } else {
                    ...
                    if (!available) {
                        System.out.println("sorry this drink does not have enough stock, please choose other drink");
                    } else {
                        orderingDrink = false;
                    }
                }
