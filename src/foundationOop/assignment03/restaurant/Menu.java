...
/**
 * create today's menu by foundationOop.assignment03.recipe.
 */
public class Menu {
    ...
    /**
     * foundationOop.assignment03.drink list
     */
    ...
    public void display() {
        ...
        System.out.print("Opening! The menu is below");
        ...
        PrintTools.loadingAnimation(null, 150L, 8);
        //4. print foundationOop.assignment03.drink list
     ...
     * and load today's recipes into foundationOop.assignment03.restaurant.Menu.
     */
    public void load() {
        System.out.println("Welcome! Our foundationOop.assignment03.restaurant is preparing... Please wait a moment...");
        // create readers to read all files
        String path = "U:\\ManW10\\Downloads\\myjava\\src\\";
        EasyReader ingredientReader = new EasyReader(path + "foundationOop/assignment03/recipe/ingredientList.txt");
        EasyReader pieReader = new EasyReader(path + "foundationOop/assignment03/recipe/pies.txt");
        EasyReader fishReader = new EasyReader(path + "foundationOop/assignment03/recipe/fish.txt");
        EasyReader steakReader = new EasyReader(path + "foundationOop/assignment03/recipe/steak.txt");
        EasyReader drinkReader = new EasyReader(path + "foundationOop/assignment03/recipe/drinks.txt");
        ...
        // load all meals and drinks into foundationOop.assignment03.restaurant.Menu instance fields.
    ...
    /**
     * load drinks from foundationOop.assignment03.drink list file.
     *
    ...
    private void loadDrinkList(EasyReader drinkReader) {
        while (!drinkReader.eof()) {
            ...
            // read ingredients of foundationOop.assignment03.drink
    ...
    /**
     * print foundationOop.assignment03.drink list;
     *
     * @param separatorLine  ---
     * @param rightJustified formatTemplate
     * @param typeTitle      foundationOop.assignment03.drink type title，if you want to print drinks into different type, assign this variable.
     * @param drinkList      foundationOop.assignment03.drink list
     */
    ...
    /**
     * get Drink list in foundationOop.assignment03.restaurant.Menu
     *
     * @return foundationOop.assignment03.drink list
     */
